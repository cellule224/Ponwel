...
import house.thelittlemountaindev.ponwel.CartActivity;
...
public class CheckoutCartFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapater = new CartItemsAdapater(getActivity(), productList);
        ...
        databaseReference.child("Products").child(key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    ((FinalizeOrderActivity) getActivity()).tvTotalAmount.setText(String.valueOf(totalPriceInt + " GNF"));
